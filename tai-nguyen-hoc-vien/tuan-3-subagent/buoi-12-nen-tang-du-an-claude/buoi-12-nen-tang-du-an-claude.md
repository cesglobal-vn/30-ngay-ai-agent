...
Nếu bạn còn Project cũ ở tuần 1, mở lại xem ô Instructions bên phải màn hình - đó chính là thứ sắp chuyển thành `CLAUDE.md` ở đây, chỉ khác chỗ đặt.
...
Không bán khóa học thì thay bằng sản phẩm hoặc dịch vụ chính của bạn, giữ nguyên phần còn lại của câu.
...
Ví dụ trả lời cụ thể (tham khảo mức độ chi tiết cần có):
...
Bạn sẽ thấy: bài lần này khác hẳn, đúng giọng, đúng sản phẩm. Cùng một Claude, cùng một câu lệnh, khác nhau ở chỗ nó có tờ giới thiệu hay không. Đây là khoảnh khắc quan trọng nhất buổi - để hai bài cạnh nhau đọc lại mà so.
